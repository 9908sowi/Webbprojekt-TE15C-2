...
namespace IGEN.Controllers
{
    ...
    public class GamesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,CoverArt,Title,Developer")] Game game)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,CoverArt,Title,Developer")] Game game)
        {
            if (ModelState.IsValid)
            {
